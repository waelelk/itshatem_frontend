...
function Blog() {
  ...
  if (loading)
    return (
      <div className="dark:bg-black text-center lg:p-64">
        <svg
          role="status"
              ...
              <div>
                <Link to={`/blogs/${blog.id}`}>
                  <div className=" cursor-pointer overflow-hidden transform lg:hover:scale-105 duration-500">
                    <img
                      alt="blog_img"
                      className="object-cover w-96 lg:w-96 h-40"
                      src={blog.image[0].formats.small.url}
                    />
                    <div className="p-4 ">
                      ...
                      <h3
                        className="dark:text-white lg:text-xl md:text-4xl font-regular md:text-xl tracking-tight mt-3"
                        id="title"
                      >
                        {blog.title}
                      </h3>
