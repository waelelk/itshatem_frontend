                            ...
                            <div>
                                <Link to={`/blogs/${blog.id}`}>
                                    <div className="w-50 lg:w-96 cursor-pointer overflow-hidden transform lg:hover:scale-105 duration-500">
                                        <img alt="blog_img" src={`https://hatem-portfolio.herokuapp.com${blog.import React from 'react'
import { Link } from 'react-router-dom'
import Moment from 'react-moment';
                    ...
                    {data.map(blog => (
                        <div className="lg:pr-6 pt-6 " key={blog.id}>
                            <div>
                                <Link to={`/blogs/${blog.id}`}>
                                    <div className="w-50 lg:w-96 cursor-pointer overflow-hidden transform lg:hover:scale-105 duration-500">
                                        <img alt="blog_img" src={`https://hatem-portfolio.herokuapp.com${blog.image.formats.url}`} />
