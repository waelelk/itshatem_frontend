...
function Education() {
    ...
    return (
        <section className="dark:bg-black lg:pb-44 p-10 px-10 md:p-24 md:px-28 dark:pg-white">
            <h1 data-aos="fade-up" className="dark:text-white text-3xl lg:text-6xl md:text-4xl mb-6 font-semibold">Education</h1>
            <div data-aos="fade-up" className="container mx-auto">
                    ...
                    <div className="pt-10 flex-nowrap lg:flex">
                        <div className="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
                            <h2 className="dark:text-white text-2xl font-medium">BS: COMPUTER SCIENCE</h2>
                            <p className="dark:text-white text-xl lg:text-xl md:text-2xl font-regular pt-3">2014-2020</p>
                        </div>
                        <div className="md:flex-grow lg:pt-0 md:pt-10">
                            <h2 className="dark:text-white text-xl lg:text-3xl md:text-4xl font-medium">University of Malaya</h2>
